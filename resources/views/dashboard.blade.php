...
<html lang="en">
  ...
  <head>
    ...
    <meta name="theme-color" content="#797979" media="(prefers-color-scheme: light)" />
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Dashboard v2</h1>
              </div>
              <div class="col-sm-6">
                        ...
                        >
                          ...
                          <div class="direct-chat-msg">
                            ...
                            <img
                              ...
                              src="./assets/dist/assets/img/user1-128x128.jpg"
    ...
    <script>
      ...
      const pie_chart_options = {
        ...
        colors: ['#0d6efd', '#20c997', '`#878484', '#0edf1f', '#075951', '#0058af'],
      };
